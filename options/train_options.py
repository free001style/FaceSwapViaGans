...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--train_D', default=True, type=bool,
                                 help='Whether to train the styleGAN Discrininator')
        ...
        self.parser.add_argument('--d_reg_every', default=-1, type=int,
        ...
        self.parser.add_argument('--image_interval', default=200 * 5 * 2, type=int,
        ...
        self.parser.add_argument('--face_parsing_lambda', default=0.1, type=float,
                                 help='Face parsing loss multiplier factor')
        self.parser.add_argument('--l2_lambda', default=1.0, type=float, help='L2 loss multiplier factor')
        self.parser.add_argument('--eye_detector_lambda', default=1500, type=float,
                                 help='Eye detector loss multiplier factor')
        ...
        self.parser.add_argument('--style_code_lambda', default=2e4, type=float,
                                 help='style code loss multiplier factor')
        self.parser.add_argument('--structure_code_lambda', default=0, type=float,
                                 help='structure code loss multiplier factor')

        self.parser.add_argument('--style_loss_norm', default=1, type=int,
                                 help='whether to normalize the [-1, 1] image to ImageNet in style loss')
