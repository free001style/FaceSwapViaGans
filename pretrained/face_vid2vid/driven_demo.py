...
from pretrained.face_vid2vid.sync_batchnorm import DataParallelWithCallback
from pretrained.face_vid2vid.modules.generator import OcclusionAwareGenerator, OcclusionAwareSPADEGenerator
from pretrained.face_vid2vid.modules.keypoint_detector import KPDetector, HEEstimator
...
def init_facevid2vid_pretrained_model(cfg_path, ckpt_path):
    generator, kp_detector, he_estimator = load_checkpoints(config_path=cfg_path, checkpoint_path=ckpt_path,
                                                            gen="spade", cpu=False)
